...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbelections', function (Blueprint $table) {
            ...
            $table->id();
            $table->dateTime('date_str_ind')->nulllable();
            $table->dateTime('date_end_ind')->nulllable();
            $table->dateTime('date_str_ele')->nulllable();
            $table->dateTime('date_end_ele')->nulllable();
            $table->dateTime('date_investigation')->nulllable();
