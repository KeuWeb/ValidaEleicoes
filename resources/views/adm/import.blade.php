            ...
            <div class="m-3 px-2 pt-3 py-2 row bg-white">
                ...
                <form id="upload-list-adm" name="upload-list-adm" class="row files" data-form="list" autocomplete="off" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-6">
                        ...
                        @if(@$link_list)
                        <small id="txt-list-progress-bar" class="mt-2 d-table fst-italic text-success">arquivo cadastrado, para acessar, <a href="../{{ @$link_list }}" target="_blank"><b class="text-success">clique aqui</b></a>.</small>                   
                        @else
