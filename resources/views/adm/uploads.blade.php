            ...
            <div class="m-3 px-2 pt-3 py-2 row bg-white">
                ...
                <form id="upload-logo-adm" name="upload-logo-adm" class="row files" data-form="logo" autocomplete="off" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-6">
                        ...
                        @if(@$link_logo)
                        <small id="txt-logo-progress-bar" class="mt-2 d-table fst-italic text-success">arquivo cadastrado, para acessar, <a href="../{{ @$link_logo }}" target="_blank"><b class="text-success">clique aqui</b></a>.</small>                   
                        @else
                ...
                <form id="upload-doc-adm" name="upload-doc-adm" class="row files" data-form="doc" autocomplete="off" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-6">
                        ...
                        @if(@$link_doc)
                        <small id="txt-doc-progress-bar" class="mt-2 d-table fst-italic text-success">arquivo cadastrado, para acessar, <a href="../{{ @$link_doc }}" target="_blank"><b class="text-success">clique aqui</b></a>.</small>                   
                    @else
