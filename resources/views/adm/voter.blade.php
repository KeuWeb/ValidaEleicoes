<html>
    ...
    <body class="w-100" style="background-color: #EEE;">
        ...
        <div id="container-system">
            @include('adm/header')
            <p class="m-3 p-3 bg-success text-white"><a href="cpanel">CPanel</a> <i class="bi bi-caret-right-fill text-white"></i> Cadastrar Usuário</p>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Nome completo" value="" required>
                                <label for="company">Nome completo*</label>
                            </div>
                        </div>

                        <div class="col-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control mask" data-ref="rg" id="rg" name="rg" maxlength="14" placeholder="00.000.000-00" value="" required>
                                <label for="cnpj">RG <small class="fst-italic">(somente números)</small></label>
                            </div>
                        </div>

                        <div class="col-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control mask" data-ref="cpf" id="cpf" name="cpf" maxlength="14" placeholder="000.000.000-00" value="{{ @$cnpj }}" required>
                                <label for="cnpj">CPF <small class="fst-italic">(somente números)</small></label>
                            </div>
                        </div>
                    </div>
